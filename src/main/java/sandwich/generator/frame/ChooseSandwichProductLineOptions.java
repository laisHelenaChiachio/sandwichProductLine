...
public class ChooseSandwichProductLineOptions {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChooseSandwichProductLineOptions window = new ChooseSandwichProductLineOptions();
	 ...
	 */
	public ChooseSandwichProductLineOptions() {
		initialize();
	}
  ...
  public static class ChooseSandwichLineOnly {
